...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($invalid) {
        ...
        if ($saved == true) {                                          
            redirect('articles.php', ['success' => 'Success: The article was saved successfully!']); 
        } else {                                                       
            
        redirect('articles.php', ['failure' => 'Warning:  The article title is already in use, try again!']);
            ...
            <section class="image">
                ...
                <?php if (!$article['image_file']) { ?>
                    ...
                    <div class="form-group image-placeholder">
                        <!-- <input type="file" name="image[]" multiple="" class="form-control-file" id="image[]"><br> -->
            ...
            <section class="text">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subtitle" id="subtitle" value="<?= $article['subtitle'] ?>"
                        class="form-control">
                    <span class="errors"><?= $errors['subtitle'] ?></span>
                </div>
                <div class="form-group">
